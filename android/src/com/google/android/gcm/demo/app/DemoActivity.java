...
public class DemoActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (checkPlayServices()) {
            ...
            {
		// Optional: This may have been done once the first time in registerInBackground.
    ...
    private void getAliases() {
		...
		Uri uri = Uri.parse("http://mdk.fr:8080")
			.buildUpon()
			.path("/alias")
    ...
    private void sendRegistrationIdToBackend(String regId) {
        //mDisplay.append("Sending registration ID to server\n");
	...
	protected HttpResponse doInBackground(String... regIds) {
		String url = "http://mdk.fr:8080/register";
	...
	protected void onPostExecute(HttpResponse response) {
		...
		if (httpStatus.getStatusCode() != 200) {
			...
			mDisplay.append(httpStatus.getReasonPhrase() + "\n");
			return;
		}

		mDisplay.append("Id sent to server.\n");
	}
    }
}